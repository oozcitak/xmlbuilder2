...
export class DOMError {
  ...
  static DOMStringSizeError = new Error("DOMStringSizeError:")
  ...
  static NoDataAllowedError = new Error("NoDataAllowedError:")
  ...
  static InUseAttributeError = new Error("InUseAttributeError:")
  ...
  static ValidationError = new Error("ValidationError:")
  static TypeMismatchError = new Error("TypeMismatchError:")
